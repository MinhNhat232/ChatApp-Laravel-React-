    ...
    return (
        <Transition show={show} as={Fragment} leave="duration-200">
            ...
            <Dialog
                ...
                onClose={onClose} // Giả sử hàm onClose là props truyền vào, như đã thấy ở ảnh trước
            >
                {/* Background mờ (Overlay/Backdrop) */}
                <Transition.Child
                    as={Fragment}
                    ...
                    <div className="h-screen w-screen">
                       ...
                       shadow-xl transition-all"
                            >
                                ...
                                <button
                                    onClick={close} // Giả sử 'close' là hàm được truyền vào hoặc định nghĩa trong component
               ...
               justify-center text-gray-100 z-40"
                                ...
                                {/* Container chứa nội dung xem trước và các nút điều hướng */}
                                <div className="relative group h-full">

                                    {/* Nút Điều hướng Lùi (Previous) */}
                                    {/* Chỉ hiển thị nút này nếu currentIndex lớn hơn 0 */}
                                    {currentIndex > 0 && (
                                        <div
                                            onClick={prev} // Giả sử 'prev' là hàm chuyển đến tệp trước đó
                                    ...
                                    {/* Nút Điều hướng Tiếp theo (Next) */}
                                    {/* Chỉ hiển thị nút này nếu chưa phải là tệp cuối cùng */}
                                    {currentIndex < previewableAttachments.length - 1 && (
                                        <div
                                            onClick={next} // Giả sử 'next' là hàm chuyển đến tệp tiếp theo
                                            className="absolute opacity-100 text-gray-100
                       cursor-pointer flex items-center justify-center
                       ...
                       rounded-full bg-black/50 z-30"
                                    ...
                                    <div className="flex items-center justify-center w-full h-full p-3">
                                        ...
                                        {/* Hiển thị Audio nếu tệp là Audio */}
                                        {isAudio(attachment) && (
                                        ...
                                        {/* Hiển thị thông báo nếu tệp KHÔNG thể xem trước */}
