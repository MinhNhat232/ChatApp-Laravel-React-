        ...
        Echo.join('online')
            .here((users) => {
                ...
                setOnlineUsers((prevOnlineUser) => {
                    return { ...prevOnlineUser, ...onlineUsers };
                    ...
                    <div className="flex-1 overflow-auto">
                        {sortedConversation && sortedConversation.map((conversation) => (
                            <ConversationItem
                                ...
                                conversation={conversation} // ✅ Truyền đúng item
                                online={!!isUserOnline(conversation.id)} // ✅ Kiểm tra đúng user
